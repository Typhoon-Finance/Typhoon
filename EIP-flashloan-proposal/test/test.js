...
describe("*Typhoon* Flashloan Standard", function() {
  ...
  const tellorPriceFeeds = [39]; // DAI?USD
  const tellorAddress = '0x88dF592F8eb5D7Bd38bFeF7dEb0fBc02cf3778a0';
  const exchanges = ["0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac", "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f"]; // routers for Sushiswap and Uniswap
